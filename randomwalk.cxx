...
void push(colloid* c, int* rx, int* ry, const int N, const double step);
void statistics(colloid* c, double& meanx, double& meany, double& var, const int N);
...
int main(void){
	...
	for(int j = 0; j < Nsubsteps; j++){
	    ...
	    statistics(c,var,meanx,meany,N);	// call to function which evaluates statistics
...
void statistics(colloid* c, double& var, double& meanx, double& meany, const int N)
{
meanx=0;
meany=0;
var=0;
